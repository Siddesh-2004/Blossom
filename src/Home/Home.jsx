...
function Home() {
  ...
  const img8 =
    ...
    const customer1 = {
      ...
      reviewContent: "Absolutely stunning flowers! They arrived fresh and on time. Highly recommend!",
    ...
    const customer2 = {
      ...
      reviewContent: "Good service but the flowers could have been arranged better. Still loved them!",
    ...
    const customer3 = {
      ...
      reviewContent: "The bouquet was gorgeous, and the fragrance lasted for days. Will order again!",
    ...
    const customer4 = {
      ...
      reviewContent: "Beautiful flowers but slightly delayed delivery. Otherwise, great experience!",
    ...
    const customer5 = {
      ...
      reviewContent: "Perfect gift for my mom's birthday. She absolutely loved it!",
    ...
    const customer6 = {
      ...
      reviewContent: "Ordered for Valentine's Day. My partner was delighted! Beautiful arrangement!",
    ...
    const customer7 = {
      ...
      reviewContent: "Lovely flowers, but a bit expensive. Still, the quality is worth it!",
    ...
    const customer8 = {
      ...
      reviewContent: "Excellent customer service and a beautiful arrangement. Will buy again!",
    ...
    const customer9 = {
      ...
      reviewContent: "The flowers were vibrant and fresh! Just wished the delivery was quicker.",
      reviewerName: "Kunal Sharma"
    };
    const reviews = [customer1, customer2, customer3, customer4, customer5, customer6, customer7, customer8, customer9];
